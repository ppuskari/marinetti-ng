...
The separately distributed emulator link-layer source has an explicit LGPL 2.1-or-later notice in `emulator.asm`. It can inform interface and build recovery, but it should not be confused with source for the current Uthernet II binary.
