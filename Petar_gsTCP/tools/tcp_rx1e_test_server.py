...
print("RX1-E: send one valid 1460-byte MSS.")
print("IIgs shifts parsed SEG.SEQ forward by one MSS before acceptance.")
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server:
    ...
    with conn:
        ...
        print(
            "Waiting briefly while IIgs proves "
