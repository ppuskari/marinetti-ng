...
$SourceRoot = Join-Path $RepoRoot "Petar_gsTCP\apps\pingtest"
$Source = Join-Path $SourceRoot "PGT.PINGTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTPINGTEST"
$NapsBinary = Join-Path $OutputRoot "PGTPINGTEST#B30000"
$Image = Join-Path $OutputRoot "PGTPingTest.po"
