...
$Source = Join-Path $SourceRoot "PGT.STREAMTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTSTREAMTEST"
$NapsBinary = Join-Path $OutputRoot "PGTSTREAMTEST#B30000"
$Image = Join-Path $OutputRoot "PGTStreamTest.po"
