...
$SourceRoot = Join-Path $RepoRoot "Petar_gsTCP\apps\dnstest"
$Source = Join-Path $SourceRoot "PGT.DNSTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTDNSTEST"
$NapsBinary = Join-Path $OutputRoot "PGTDNSTEST#B30000"
$Image = Join-Path $OutputRoot "PGTDNSTest.po"
