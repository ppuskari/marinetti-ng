...
$SourceRoot = Join-Path $RepoRoot "Petar_gsTCP\apps\linktest"
$Source = Join-Path $SourceRoot "PGT.LINKTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTLINKTEST"
$NapsBinary = Join-Path $OutputRoot "PGTLINKTEST#B30000"
$Image = Join-Path $OutputRoot "PGTLinkTest.po"
