...
$SourceRoot = Join-Path $RepoRoot "Petar_gsTCP\apps\dhcptest"
$Source = Join-Path $SourceRoot "PGT.DHCPTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTDHCPTEST"
$NapsBinary = Join-Path $OutputRoot "PGTDHCPTEST#B30000"
$Image = Join-Path $OutputRoot "PGTDHCPTest.po"
