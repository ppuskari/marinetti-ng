...
$SourceRoot = Join-Path $RepoRoot "Petar_gsTCP\apps\tcptest"
$Source = Join-Path $SourceRoot "PGT.TCPTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTTCPTEST"
$NapsBinary = Join-Path $OutputRoot "PGTTCPTEST#B30000"
$Image = Join-Path $OutputRoot "PGTTCPTest.po"
