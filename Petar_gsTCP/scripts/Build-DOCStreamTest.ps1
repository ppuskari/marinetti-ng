...
$SourceRoot = Join-Path $RepoRoot "Petar_gsTCP\apps\streamtest"
$Source = Join-Path $SourceRoot "PGT.DOCSTREAMTEST.S"
$OutputRoot = Join-Path $RepoRoot "build-local"
$Binary = Join-Path $OutputRoot "PGTDOCSTREAM"
$NapsBinary = Join-Path $OutputRoot "PGTDOCSTREAM#B30000"
$Image = Join-Path $OutputRoot "PGTDOCStreamTest.po"
