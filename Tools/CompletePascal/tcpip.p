...
{********************************************************
*
*  Marinetti TCP/IP interfaces for Complete Pascal
*
...
type
   errTable = packed record
      tcpDGMSTBLEN: longint;			{The total length of the error table, in bytes,
      									including tcpDGMSTBLEN}
   ...
   tuneRecord = packed record					{tuning table}
      ...
      tcpTUNEIPRUNQFREQ: integer;		{The RunQ frequency value (60ths of a
											second). The default is 30 (half a second).}
   ...
   module = packed record
      ...
      liFilename: string[15];				{Str255 filename of the module}
   ...
   linkInfoBlk = packed record
      liMethodID: integer;     {The connect method. New modules will need to apply
      							to the author for a unique ID to use. See conXXX
      							equates for details of already defined values}
      liName: string[20];		{Str255 name of the module}
      liVersion: longint;		{rVersion (type $8029 resource layout) of the module}
      liFlags: integer;			{Contains the following flags:
   ...
   IPCDataInRecord = packed record
      ...
      inwLVPtr: longint;		{long Pointer to link layer vars currently being used}
      end;
   IPCDataInPtr = ^IPCDataInRecord;

   variablesRecord = packed record
      lvVersion: integer;
      lvConnected: integer;
      lvIPaddress: longint;
      lvRefCon: longint;
   ...
   dnrTimeoutsRecord = packed record
...
procedure TCPIPReconnect (dPtr: displayPtr); tool $36, $0C;
function  TCPIPGetMyIPAddress: longint; tool $36, $0F;
function  TCPIPGetConnectMethod: integer; tool $36, $10;
procedure TCPIPSetConnectMethod (method: integer); tool $36, $11;
procedure TCPIPConnect (dPtr: displayPtr); tool $36, $12;
procedure TCPIPDisconnect (forceFlag: boolean; dPtr: displayPtr); tool $36, $13;
function  TCPIPGetMTU: integer; tool $36, $14;
function  TCPIPGetConnectData (userid: integer; method: integer): conHandle;
                tool $36, $16;
procedure TCPIPSetConnectData (method: integer; cHand: conHandle); tool $36, $17;
...
procedure TCPIPGetTuningTable (tPtr: tunePtr); tool $36, $1E;
...
procedure TCPIPGetUsername (uPtr: unBuffPtr); tool $36, $44;
procedure TCPIPSetUsername (username: Str255); tool $36, $45;
procedure TCPIPGetPassword (pPtr: pwBuffPtr); tool $36, $46;
procedure TCPIPSetPassword (password: Str255); tool $36, $47;
...
procedure TCPIPGetHostName (hPtr: hnBuffPtr); tool $36, $51;
procedure TCPIPSetHostName (hostname: Str255); tool $36, $52;
procedure TCPIPGetLinkLayer (libPtr: linkInfoBlkPtr); tool $36, $54;
function  TCPIPGetAuthMessage (userID: integer): authMsgHandle; tool $36, $57;
...
procedure TCPIPGetDNS (DNS: DNSRecPtr); tool $36, $1C;
procedure TCPIPSetDNS (DNS: DNSRecPtr); tool $36, $1D;
procedure TCPIPCancelDNR (dnr: dnrBufferPtr); tool $36, $20;
procedure TCPIPDNRNameToIP (name: Str255; dnr: dnrBufferPtr); tool $36, $21;
...
function  TCPIPReadLineTCP (ipid: integer; delimitStrPtr: Str255Ptr; buffType: integer;
...
function  TCPIPStatusTCP (ipid: integer; sPtr: srBuffPtr): integer; tool $36, $31;
...
procedure TCPIPConvertIPToHex (cvt: cvtRecPtr; sPtr: Str255Ptr); tool $36, $0D;
procedure TCPIPConvertIPCToHex (cvt: cvtRecPtr; sPtr: Str255Ptr); tool $36, $3F;
...
function  TCPIPMangleDomainName (flags: integer; dnPstringPtr: Str255Ptr):
                integer; tool $36, $59;
...
procedure TCPIPPtrToPtrNeg (fromEndPtr, toEndPtr: ptr; length: longint);
                tool $36, $56;
function  TCPIPValidateIStr255 (sPtr: Str255Ptr): boolean; tool $36, $48;
...
procedure TCPIPSetUserEventTrigger (triggerNumber, ipid: integer; tPtr: triggerProcPtr);
                tool $36, $64;
function  TCPIPGetSysEventTrigger (ipid: integer): integer; tool $36, $65;
procedure TCPIPSetSysEventTrigger (triggerNumber: integer;  tPtr: triggerProcPtr);
                tool $36, $66;
procedure TCPIPGetDNRTimeouts (dtPtr: dnrTimeoutsBuffPtr); tool $36, $67;
procedure TCPIPSetDNRTimeouts (dtPtr: dnrTimeoutsBuffPtr); tool $36, $68;
