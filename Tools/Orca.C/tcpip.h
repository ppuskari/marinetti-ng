...
* 2005-02-06 AJR Fix bugs found by Kelvin Sherlock [944099]
...
* 2012-03-25 AJR Add #include guard __TCPIP__ [3499213]
********************************************/
...
typedef struct {
    ...
    Long lvRefCon;
    Long lvErrors;
    Word lvMTU;             /* Maximum Transmission Unit size */
                            /* ... this is the Maximum Receive Unit (MRU) from the host. */
}  variablesStruct, *variablesPtr;

typedef struct {
    Word dnrRETRIES;			/* How many times	to try the DNR servers. The default is 5 */
    Word dnrTIMER;			/* Number of ticks before timeout. The default is 120=2 secs */
} dnrTimeoutsStruct, *dnrTimeoutsBuffPtr;
...
extern pascal authMsgHandle TCPIPGetAuthMessage (Word) inline(0x5736,dispatcher);
...
extern pascal void TCPIPGetDNRTimeouts (dnrTimeoutsBuffPtr) inline(0x6736,dispatcher);
extern pascal void TCPIPSetDNRTimeouts (dnrTimeoutsBuffPtr) inline(0x6836,dispatcher);
